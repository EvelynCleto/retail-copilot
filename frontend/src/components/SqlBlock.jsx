...
const s = {
  ...
  panel: { marginTop:4, borderRadius:8, overflow:"hidden", border:"1px solid rgba(255,255,255,0.07)" },
  pre:   { margin:0, padding:"10px 13px", background:"var(--sidebar)", color:"var(--linx)",
